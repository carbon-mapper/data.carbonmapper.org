...
const SourceDetailsSupportingTab = ({
    ...
    const conversionType = useEmissionConversionType();
    const { emissions: convertedEmissions, units } = convertEmissions(emissions, 0, {
        conversionType,
        gas: gas as SourceDataTypes.GasType
    });
            ...
            <table>
                <tbody>
                    ...
                    <tr>
                        ...
                        {/* handle zero */}
                        <td>{convertedEmissions === 0 ? 'N/A' : `${integerNumber(convertedEmissions)} ${units}`}</td>
                    </tr>
                </tbody>
            </table>
        </section>
