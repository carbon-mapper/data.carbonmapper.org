...
import { useInitialTrackingImpression } from '@/hooks/useInitialTrackingImpression';
...
const DashboardFilters = () => {
    ...
    const setInitTracking = useFilterStore(state => state.setInitTracking);
    ...
    useEffect(() => {
        setView('main');
        isOpen && setInitTracking(true);
        // TODO: deps
    }, [isOpen, setInitTracking, setView]);
                                        ...
                                        >
                                            ...
                                            >
                                                <FilterViewTitle
                                                    ...
                                                    onClearClick={() => setParams({ date: undefined })}
                                                />
                                                <Calendar />
                                            </FiltersViewItem>
                                        </div>
                                        ...
                                        <div className={classNames('scrollbar-hidden', styles.viewInner)}>
                                            ...
                                            >
                                                <FilterViewTitle
                                                    ...
                                                    onBackClick={() => setView('main')}
                                                    onClearClick={() => setParams({ plume_status: undefined })}
                                                />
                                                <PlumeStatusList />
                                            </FiltersViewItem>
                                        </div>
                                        ...
                                        <div className={classNames('scrollbar-hidden', styles.viewInner)}>
                                            ...
                                            >
                                                <FilterViewTitle
                                                    ...
                                                    onBackClick={() => setView('main')}
                                                    onClearClick={() => setParams({ instrument: [] })}
                                                />
                                                <InstrumentList />
                                            </FiltersViewItem>
                                        </div>
                                        ...
                                        <div className={classNames('scrollbar-hidden', styles.viewInner)}>
                                            ...
                                            >
                                                <FilterViewTitle
                                                    ...
                                                    onBackClick={() => setView('main')}
                                                    onClearClick={() => setParams({ plume_qualities: [] })}
                                                />
                                                <PlumeQualityList />
                                            </FiltersViewItem>
                                        </div>
