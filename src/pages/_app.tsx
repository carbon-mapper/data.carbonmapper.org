...
export default function App({ Component, pageProps }: AppPropsWithLayout) {
    ...
    // Other universal hooks can go here
    // I feel like i need to get rid of these element ids and the things that are hooked to them
        ...
        <QueryParamProvider adapter={NextAdapterPages}>
            <MsalProvider instance={publicClientApplication}>
                ...
                <div id='root' className={`${fonts.Graphik.variable} ${fonts.Inter.variable}`}>
                    {breakpoint === 'desktop' && <main id='main'>{getLayout(<Component {...pageProps} />)}</main>}
